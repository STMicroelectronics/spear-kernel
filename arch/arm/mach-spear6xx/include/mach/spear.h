...
#define VA_SPEAR6XX_ICM1_UART0_BASE	UL(0xFD000000)
#define SPEAR6XX_ICM1_JPEG_BASE		UL(0xD0800000)
#define SPEAR6XX_ICM1_SRAM_BASE		UL(0xD2800000)
#define VA_SPEAR6XX_ICM1_SRAM_BASE	UL(0xFE280000)
...
#define VA_SPEAR6XX_ICM3_SDR_CTRL_BASE	(VA_SPEAR6XX_ICM3_SMI_CTRL_BASE | SPEAR6XX_ICM3_SDRAM_CTRL_BASE)

#define SPEAR6XX_GETH_BASE		UL(0xE0800000)
