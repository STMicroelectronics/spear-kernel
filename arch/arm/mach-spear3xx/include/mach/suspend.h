...
#define SRAM_START_PA		SPEAR3XX_ICM1_SRAM_BASE
#define SRAM_START_VA		VA_SPEAR3XX_ICM1_SRAM_BASE
...
#define SYS_CTRL_BASE_VA	VA_SPEAR3XX_ICM3_SYS_CTRL_BASE
#define MPMC_BASE_VA		VA_SPEAR3XX_ICM3_SDR_CTRL_BASE
#define MISC_BASE_VA		VA_SPEAR3XX_ICM3_MISC_REG_BASE
