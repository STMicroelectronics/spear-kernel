...
#define VA_MISC_BASE		IOMEM(VA_SPEAR3XX_ICM3_MISC_REG_BASE)
...
#define VA_PLGPIO3_PAD_PRG	(VA_MISC_BASE + 0x13C)
#define VA_PLGPIO4_PAD_PRG	(VA_MISC_BASE + 0x140)
