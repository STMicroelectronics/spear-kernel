...
#define SPEAR320_FSMC_BASE		UL(0x4C000000)
	#define SPEAR320_PLAT_NAND_CLE	(1 << 16)
	#define SPEAR320_PLAT_NAND_ALE	(1 << 17)
#define SPEAR320_NAND_BASE		UL(0x50000000)

#define SPEAR320S_UART5_BASE		UL(0x60000000)
#define SPEAR320S_UART6_BASE		UL(0x60100000)
...
#define SPEAR320_SSP1_BASE		UL(0xA5000000)
#define SPEAR320_SSP2_BASE		UL(0xA6000000)
#define SPEAR320_I2C_BASE		UL(0xA7000000)
#define SPEAR320_PWM_BASE		UL(0xA8000000)

#define SPEAR320S_I2C2_BASE		UL(0xA9000000)
#define SPEAR320S_UART3_BASE		UL(0xA9100000)
#define SPEAR320S_UART4_BASE		UL(0xA9200000)
#define SPEAR320S_RS485_BASE		UL(0xA9300000)
#define SPEAR320S_I2S_BASE		UL(0xA9400000)

#define SPEAR320_ETH0_BASE		UL(0xAA000000)
#define SPEAR320_ETH1_BASE		UL(0xAB000000)
...
#define SPEAR320_INT_ENB_MASK_REG		0x08
	...
	#define SPEAR320_ETH0_IRQ_MASK			(1 << 17)
	#define SPEAR320_ETH1_IRQ_MASK			(1 << 18)
	#define SPEAR320_WAKEUP_ETH0_IRQ_MASK		(1 << 19)
	#define SPEAR320_WAKEUP_ETH1_IRQ_MASK		(1 << 20)
...
#define VA_SPEAR320_CONTROL_REG		IOMEM(IO_ADDRESS(SPEAR320_CONTROL_REG))
...
#define VA_SPEAR320S_EXT_CTRL_REG	IOMEM(IO_ADDRESS(SPEAR320S_EXT_CTRL_REG))
