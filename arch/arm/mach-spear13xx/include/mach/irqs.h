...
#define SPEAR1310_IRQ_FSMC_PC1		(IRQ_SHPI_START + 76)
#define SPEAR1310_IRQ_FSMC_PC2		(IRQ_SHPI_START + 77)
#define SPEAR1310_IRQ_FSMC_PC3		(IRQ_SHPI_START + 78)
#define SPEAR1310_IRQ_FSMC_PC4		(IRQ_SHPI_START + 79)
#define SPEAR1310_IRQ_RS4850		(IRQ_SHPI_START + 80)
#define SPEAR1310_IRQ_RS4851		(IRQ_SHPI_START + 81)
#define SPEAR1310_IRQ_CCAN0		(IRQ_SHPI_START + 82)
#define SPEAR1310_IRQ_CCAN1		(IRQ_SHPI_START + 83)
#define SPEAR1310_IRQ_TDM0		(IRQ_SHPI_START + 84)
#define SPEAR1310_IRQ_TDM1		(IRQ_SHPI_START + 85)
#define SPEAR1310_IRQ_UART1		(IRQ_SHPI_START + 86)
#define SPEAR1310_IRQ_UART2		(IRQ_SHPI_START + 87)
#define SPEAR1310_IRQ_UART3		(IRQ_SHPI_START + 88)
#define SPEAR1310_IRQ_UART4		(IRQ_SHPI_START + 89)
#define SPEAR1310_IRQ_UART5		(IRQ_SHPI_START + 90)
#define SPEAR1310_IRQ_I2C_CNTR		(IRQ_SHPI_START + 91)
#define SPEAR1310_IRQ_GETH1_SBD		(IRQ_SHPI_START + 92)
#define SPEAR1310_IRQ_GETH1_PMT		(IRQ_SHPI_START + 93)
#define SPEAR1310_IRQ_GETH2_SBD		(IRQ_SHPI_START + 94)
#define SPEAR1310_IRQ_GETH2_PMT		(IRQ_SHPI_START + 95)
#define SPEAR1310_IRQ_GETH3_SBD		(IRQ_SHPI_START + 96)
#define SPEAR1310_IRQ_GETH3_PMT		(IRQ_SHPI_START + 97)
#define SPEAR1310_IRQ_GETH4_SBD		(IRQ_SHPI_START + 98)
#define SPEAR1310_IRQ_GETH4_PMT		(IRQ_SHPI_START + 99)
#define SPEAR1310_IRQ_PLGPIO		(IRQ_SHPI_START + 100)
#define SPEAR1310_IRQ_PCI_BRDG_HOST_FATAL (IRQ_SHPI_START + 101)
#define SPEAR1310_IRQ_PCI_INTA		(IRQ_SHPI_START + 102)
#define SPEAR1310_IRQ_PCI_INTB		(IRQ_SHPI_START + 103)
#define SPEAR1310_IRQ_PCI_INTC		(IRQ_SHPI_START + 104)
#define SPEAR1310_IRQ_PCI_INTD		(IRQ_SHPI_START + 105)
#define SPEAR1310_IRQ_PCI_ME_TO_ARM	(IRQ_SHPI_START + 106)
#define SPEAR1310_IRQ_PCI_SERR_TO_ARM	(IRQ_SHPI_START + 107)
...
#define SPEAR1340_IRQ_SPDIFF_IN		(IRQ_SHPI_START + 84)
#define SPEAR1340_IRQ_SPDIFF_OUT	(IRQ_SHPI_START + 85)
#define SPEAR1340_IRQ_VIDEO_IN		(IRQ_SHPI_START + 86)
