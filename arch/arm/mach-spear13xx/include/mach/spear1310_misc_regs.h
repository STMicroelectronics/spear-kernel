...
#define VA_SPEAR1310_CLCD_CLK_SYNT_MOD		(VA_MISC_BASE + 0x294)
#define VA_SPEAR1310_EXPI_CPU_SYNT		(VA_MISC_BASE + 0x298)
#define VA_SPEAR1310_EXPI_CPU_SYNT_MOD		(VA_MISC_BASE + 0x274)
#define VA_SPEAR1310_RAS_CLK_SYNT0		(VA_MISC_BASE + 0x278)
#define VA_SPEAR1310_RAS_CLK_SYNT0_MOD		(VA_MISC_BASE + 0x27C)
#define VA_SPEAR1310_RAS_CLK_SYNT1		(VA_MISC_BASE + 0x280)
#define VA_SPEAR1310_RAS_CLK_SYNT1_MOD		(VA_MISC_BASE + 0x284)
#define VA_SPEAR1310_RAS_CLK_SYNT2		(VA_MISC_BASE + 0x288)
#define VA_SPEAR1310_RAS_CLK_SYNT2_MOD		(VA_MISC_BASE + 0x28C)
#define VA_SPEAR1310_RAS_CLK_SYNT3		(VA_MISC_BASE + 0x290)
