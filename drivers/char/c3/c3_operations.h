...
#define MPR_LOAD(SN_memory_pool, first_SN_offset, SNs_number, prgmem) \
	do { \
		*(prgmem++) = \
			((MPR_CHANNEL_INFO.channel_idx << 28) + /* Mod Num */ \
			 (2 << 26) +    /* Add Instr Words: 2 (27-26) */ \
			 (0 << 21) +    /* Operation: MPR_LOAD (22-21) */ \
			 SNs_number);   /* Number of SNs to be loaded */ \
		*(prgmem++) = SN_memory_pool; \
		*(prgmem++) = first_SN_offset; \
	} while (0)

/* ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: */
/* ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: */

#define MPR_INIT(parameters, prgmem) \
	do { \
		*(prgmem++) = \
			((MPR_CHANNEL_INFO.channel_idx << 28) + /* Mod Num */ \
			 (1 << 26) +    /* Add Instr Words: 1 (27-26) */ \
			 (1 << 21));    /* Operation: MPR_INIT (22-21) */ \
		*(prgmem++) = parameters; \
	} while (0)
...
#define MPR_APPEND(input, input_len, prgmem) \
	do { \
		*(prgmem++) = \
			((MPR_CHANNEL_INFO.channel_idx << 28) + /* Mod Num */ \
			 (1 << 26) +    /* Add Instr Words: 1 (27-26) */ \
			 (2 << 21) +    /* Operation: MPR_APPEND (22-21) */ \
...
#define MPR_END(status, prgmem)	\
	do { \
		*(prgmem++) = \
			((MPR_CHANNEL_INFO.channel_idx << 28) + /* Mod Num */ \
			 (1 << 26) +    /* Add Instr Words: 1 (27-26) */ \
			 (3 << 21));    /* Operation: MPR_END (22-21) */ \
		*(prgmem++) = status; \
	} while (0)
...
#define SP_SEND_RECEIVE(standby, buf_size, srcptr, destptr, prgmem) \
	do { \
		*(prgmem++) = \
			((SP_CHANNEL_INFO.channel_idx << 28) +  /* Mod Num */ \
			 (2 << 26) +    /* Add Instr Words: 2 (27-26) */ \
			 (0 << 25) +    /* Mode: 0 = Normal, 1 = Dbg (25) */ \
			 (0 << 24) +    /* SP_send_receive = 0(24) */ \
			 (0 << 13) +    /* unused (23-13) */ \
			 (standby << 12) +      /* standby (12) */ \
			 buf_size);     /* Response buffer size (11-0)*/ \
		*(prgmem++) = srcptr; \
		*(prgmem++) = destptr; \
	} while (0)
...
#define SP_TIMEOUT(srcptr, prgmem) \
	do { \
		*(prgmem++) = \
			((SP_CHANNEL_INFO.channel_idx << 28) +  /* Mod Num */ \
			 (1 << 26) +    /* Add Instr Words: 1 (27-26) */ \
			 (0 << 25) +    /* Mode: 0 = Normal, 1 = Dbg (25) */ \
			 (1 << 24) +    /* SP_timeout = 1 (24) */ \
			 (0 << 23));    /* unused (23-13) */ \
		*(prgmem++) = srcptr; \
	} while (0)
...
#define SP_DEBUG_READ(lpc_addr, destptr, prgmem) \
	do { \
		*(prgmem++) = \
			((SP_CHANNEL_INFO.channel_idx << 28) +  /* Mod Num */ \
			 (1 << 26) +    /* Add Instr Words: 1 (27-26) */ \
			 (1 << 25) +    /* Mode: 0 = Normal, 1 = Dbg (25) */ \
			 (0 << 24) +/*Mode:0=READ/STANDBY, 1 = Write (24) */ \
			 (0 << 23) +    /* Read = 0, Standby = 1 (23) */ \
			 lpc_addr);     /* LPC Address */ \
		*(prgmem++) = destptr; \
	} while (0)
...
#define SP_DEBUG_STANDBY(prgmem) \
	do { \
		*(prgmem++) = \
			((SP_CHANNEL_INFO.channel_idx << 28) +  /* Mod Num */ \
			 (0 << 26) +    /* Add Instr Words: 1 (27-26) */ \
			 (1 << 25) +    /* Mode: 0 = Normal, 1 = Dbg (25) */ \
			 (0 << 24) + /* Mode: 0 = READ/STANDBY,1 = Write (24)*/\
			 (1 << 23));    /* Read = 0, Standby = 1 (23) */ \
	} while (0)

/* ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: */
/* ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: */

#define SP_DEBUG_WRITE(lpc_addr, lpc_data, prgmem) \
	do { \
		*(prgmem++) = \
			((SP_CHANNEL_INFO.channel_idx << 28) +  /* Mod Num */ \
			 (0 << 26) +    /* Add Instr Words: 1 (27-26) */ \
			 (1 << 25) +    /* Mode: 0 = Normal, 1 = Dbg (25) */ \
			 (1 << 24) + /* Mode: 0 = READ/STANDBY,1 = Write (24)*/\
			 (lpc_data << 16) +     /* lpc_data (23-16) */ \
			 (lpc_addr));   /* lpc_addr (15-0) */ \
	} while (0)
...
#define GP_LOAD_FIRMWARE(address, size, prgmem)	\
	do { \
		*(prgmem++) = \
			((GP_CHANNEL_INFO.channel_idx << 28) +  /* Mod Num */ \
			 (2 << 26) +    /* Add Instr Words: 2 (27-26) */ \
			 (0 << 23));    /* Instruction: LOAD_FIRMWARE(25-23) */\
		*(prgmem++) = address;  /* Firmware address in system mem */ \
		*(prgmem++) = size;     /* Firmware size */ \
	} while (0)

/* ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: */
/* ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: */

#define GP_RUN(param1, param2, param3, prgmem) \
	do { \
		*(prgmem++) = \
			((GP_CHANNEL_INFO.channel_idx << 28) +  /* Mod Num */ \
			 (3 << 26) +    /* Add Instr Words: 3 (27-26) */ \
			 (1 << 23));    /* Instruction: RUN (25-23) */ \
		*(prgmem++) = param1; \
		*(prgmem++) = param2; \
		*(prgmem++) = param3; \
	} while (0)
...
#define GP_SETUP(dbg_in, dbg_out, size, prgmem)	\
	do { \
		*(prgmem++) = \
			((GP_CHANNEL_INFO.channel_idx << 28) +  /* Mod Num */ \
			 (2 << 26) +    /* Add Instr Words: 2 (27-26) */ \
			 (2 << 23) +    /* Instruction: SETUP (25-23) */ \
			 size); /* Dbg area size (15-0) */ \
		*(prgmem++) = dbg_in;   /* Input dbg area */ \
		*(prgmem++) = dbg_out;  /* Output dbg area */ \
	} while (0)

/* ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: */
/* ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: */

#define GP_DUMP_MEMORY(gpmem_address, buf, size, prgmem) \
	do { \
		*(prgmem++) = \
			((GP_CHANNEL_INFO.channel_idx << 28) +  /* Mod Num */ \
			 (3 << 26) +    /* Add Instr Words: 2 (27-26) */ \
			 (3 << 23));    /* Instruction: DUMP_MEMORY (25-23) */ \
		*(prgmem++) = gpmem_address;    /* GP internal mem address */ \
		*(prgmem++) = buf;      /* Sys Buf address */ \
		*(prgmem++) = size;     /* Sys Buf size */ \
	} while (0)
