...
#undef  MPR_CHANNEL_INFO		/* {Not Available} */
#undef  IPSEC_CHANNEL_INFO		/* {Not Available} */
#undef  SP_CHANNEL_INFO			/* {Not Available} */
#undef  GP_CHANNEL_INFO			/* {Not Available} */
...
#undef  USE_SP_SCATTER_GATHER		/* No scatter/gather */
#undef  SG_ENABLED
...
#define C3_IDS_COUPLE_PATH		((unsigned int)2)  /* TODO:CHECK */
...
#define DES_CHANNEL_INFO		((c3_alg_info_t) { 0x0, 0x1 })
#undef  AES_CHANNEL_INFO		/* {Not Available} */
...
#define LOCAL_MEMORY_ADDRESS		((unsigned int)0xF0000000)
