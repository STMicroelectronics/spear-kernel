...
} /* static int __c3_AES_XCBC_MAC_96 */
...
typedef struct test_AES_XCBC_MAC_96_t {
...
} test_AES_XCBC_MAC_96_t;

/* ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: */
/* ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: */

static test_AES_XCBC_MAC_96_t test_AES_XCBC_MAC_96_vector_1 = {
	{
...
static test_AES_XCBC_MAC_96_t test_AES_XCBC_MAC_96_vector_2 = {
	{
		0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
		0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f
	},
...
static test_AES_XCBC_MAC_96_t test_AES_XCBC_MAC_96_vector_3 = {
	{
		0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
		0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f
	},
...
static test_AES_XCBC_MAC_96_t test_AES_XCBC_MAC_96_vector_4 = {
	{
		0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
		0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f
	},
...
static test_AES_XCBC_MAC_96_t test_AES_XCBC_MAC_96_vector_5 = {
	{
		0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
		0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f
	},
...
static test_AES_XCBC_MAC_96_t test_AES_XCBC_MAC_96_vector_6 = {
	{
		0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
		0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f
	},
...
(
	test_AES_XCBC_MAC_96_t *test_AES_XCBC_MAC_96
)
{
	...
	message = kmalloc(message_len, GFP_KERNEL | GFP_DMA);
	key = kmalloc(key_len, GFP_KERNEL | GFP_DMA);
	output = kmalloc(AES_XCBC_MAC_96_OUTPUT_LEN, GFP_KERNEL | GFP_DMA);
	...
	/* if ((err = __c3_MPCM_AES_XCBC_MAC_96(... */
...
{
	if ((__test_MPCM_AES_XCBC_MAC_96(&test_AES_XCBC_MAC_96_vector_1) ==
			C3_OK) &&
...
} /* static int c3_autotest_AES_XCBC_MAC_96 */
...
static unsigned int c3_autotest_local_memory(void)
{
	...
	buf1 = kmalloc(size, GFP_KERNEL | GFP_DMA);
	buf2 = kmalloc(size, GFP_KERNEL | GFP_DMA);
	...
	if (((c3_write_local_memory(buf1, 0, size, NULL, 0)) != C3_OK) ||
		((c3_read_local_memory(0, buf2, size, NULL, 0)) != C3_OK)) {
		err = C3_ERR;
		goto cleanup;
...
} /* static unsigned int c3_autotest_local_memory */
...
} /* static int c3_autotest_DES_CBC */
...
} /* static int c3_autotest_3DES_CBC */
...
} /* static int c3_autotest_AES128_CBC */
...
unsigned int c3_autotest(void)
{
	...
	des_ivec = kmalloc(8, GFP_KERNEL | GFP_DMA);
	des_key = kmalloc(8, GFP_KERNEL | GFP_DMA);
	des3_key = kmalloc(24, GFP_KERNEL | GFP_DMA);
	...
	sha1_digest = kmalloc(C3_DRIVER_SHA1_OUT_LEN, GFP_KERNEL | GFP_DMA);
	sha1_hmac_key = kmalloc(C3_DRIVER_SHA1_OUT_LEN, GFP_KERNEL | GFP_DMA);
	...
	aes_ivec = kmalloc(16, GFP_KERNEL | GFP_DMA);
	aes128_key = kmalloc(16, GFP_KERNEL | GFP_DMA);
	aes256_key = kmalloc(32, GFP_KERNEL | GFP_DMA);
