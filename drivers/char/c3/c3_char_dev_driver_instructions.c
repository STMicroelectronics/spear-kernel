...
/* -------------------------------- GP  ---------------------------*/
{ C3_CDD_GP_load_firmware, &c3_GP_load_firmware, C3_GP_LOAD_FIRMWARE_FUNCTION,
	1,
#ifdef USE_GP_SCATTER_GATHER
	1,
#else
	0,
#endif
	{ { C3_BUFFER_INPUT, 0, 1, 0 }, /* Firmware data */
	} }, { C3_CDD_GP_run, &c3_GP_run, C3_GP_RUN_FUNCTION, 1,
#ifdef USE_GP_SCATTER_GATHER
	1,
#else
	0,
#endif
	{ { C3_BUFFER_OUTPUT | C3_BUFFER_INPUT, 1, 2, 0 }, /* Buffer */
	} }, { C3_CDD_GP_dump_memory, &c3_GP_dump_memory,
	C3_GP_DUMP_MEMORY_FUNCTION, 1,
#ifdef USE_GP_SCATTER_GATHER
	1,
#else
	0,
#endif
	{ { C3_BUFFER_OUTPUT, 1, 2, 0 }, /* Buffer */
	} },
/* -------------------------------- SP  ---------------------------*/
{ C3_CDD_SP_send_receive, &c3_SP_send_receive, C3_SP_SEND_RECEIVE_FUNCTION, 2,
#ifdef USE_SP_SCATTER_GATHER
	1,
#else
	0,
#endif
	{ { C3_BUFFER_INPUT, 0, 1, 0 }, /* Input buffer */
	{ C3_BUFFER_OUTPUT, 2, 3, 0 }, /* Output buffer */
	} }, { C3_CDD_SP_timeout, &c3_SP_timeout, C3_SP_TIMEOUT_FUNCTION, 1,
#ifdef USE_SP_SCATTER_GATHER
	1,
#else
	0,
#endif
	{ { C3_BUFFER_INPUT, 0, -1, 0x4 }, /* Timeout buffer */
	} }, { C3_CDD_SP_read, &c3_SP_read, C3_SP_READ_FUNCTION, 1,
#ifdef USE_SP_SCATTER_GATHER
	1,
#else
	0,
#endif
	{ { C3_BUFFER_OUTPUT, 1, -1, 0x4 }, /* Output buffer */
	} }, { C3_CDD_SP_standby, &c3_SP_standby, C3_SP_STANDBY_FUNCTION, 0,
#ifdef USE_SP_SCATTER_GATHER
	1,
#else
	0,
#endif
	{ { 0, 0, 0, 0 } /* No Buffer */
	} }, { C3_CDD_SP_write, &c3_SP_write, C3_SP_WRITE_FUNCTION, 0,
#ifdef USE_SP_SCATTER_GATHER
	1,
#else
	0,
