...
static struct regval_list vs6725_patch1[] = {
	...
	{0x9060, 0xC3}, {0x9061, 0x74}, {0x9063, 0x91}, {0x9064, 0x9F},
	{0x9065, 0xFF}, {0x9066, 0x74}, {0x9067, 0x01}, {0x9068, 0x9E},
	{0x9069, 0xFE}, {0x906A, 0xEF}, {0x906B, 0x25}, {0x906C, 0xE0},
	{0x906D, 0xFF}, {0x906E, 0xEE}, {0x906F, 0x33}, {0x9070, 0x90},
	{0x9071, 0x00}, {0x9072, 0x32}, {0x9073, 0xF0}, {0x9074, 0xA3},
	{0x9075, 0xEF}, {0x9076, 0xF0}, {0x9077, 0x90}, {0x9078, 0x04},
	{0x9079, 0xF8}, {0x907A, 0xE0}, {0x907B, 0xFC}, {0x907C, 0xA3},
	{0x907D, 0xE0}, {0x907E, 0xFD}, {0x907F, 0xAE}, {0x9080, 0x04},
	{0x9081, 0x78}, {0x9082, 0x02}, {0x9083, 0xCE}, {0x9084, 0xC3},
	{0x9085, 0x13}, {0x9086, 0xCE},
	...
	{0x90F0, 0x12}, {0x90F1, 0x7A}, {0x90F2, 0xBA}, {0x90F3, 0x12},
	{0x90F4, 0x79}, {0x90F5, 0xA5}, {0x90F6, 0xA3}, {0x90F7, 0xEE},
	{0x90F8, 0xF0}, {0x90F9, 0xA3},
	...
	{0xe01c, 0x06}, {0xe01D, 0x20}, {0xe01E, 0x04}, {0xe01E, 0x61},
	{0xe01F, 0x02},
